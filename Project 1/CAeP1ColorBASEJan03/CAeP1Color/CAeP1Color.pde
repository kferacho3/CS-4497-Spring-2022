...
CLR C1=K(98,0,0), C2=K(245,216,99), C3=K(131,5,157);
...
CLR backgroundColor, accentColor; // Computed colors:    Mean (background) Cm   and    Accent Ca  

int selectedColor=1; // for pasting from clipboard or editing with mouse+'r','g','b','x','y','z','l','c', or 'h'
CLR K_RGB, K_XYZ, K_LAB, K_LCH; // selected color in different color spaces (used during editing)
...
void draw() // Executed at each frame
  ...
  if(showing==_cover)
    ...
    String SK1 = "RGB="+K_RGB.S(), SK2 = "XYZ="+K_XYZ.S(), SK3 = "LAB="+K_LAB.S(), SK4 = "LCH="+K_LCH.S();
